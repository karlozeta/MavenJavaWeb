...
public class DefaultRandomNumberGeneratorTest
{
    ...
    {
	Assert.assertSame("El nombre no es el esperado: ", "Generador aleatorio de numeros", generadorAleatorio.name());
    }
	...
	assertTrue("El numero aleatorio generado no esta entre 5 y 10: ", generatedInt >= 5 && generatedInt <= 10);
    }
